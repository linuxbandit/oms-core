...
//server.post({path: '/authenticate', version: '0.0.6'} , core.authenticate );//not here anymore
server.get({path: '/testmail', version: '0.0.6'} , core.testmail );
...
server.post({path: userPath + '/create' , version: '0.0.7'} , core.createUser);
server.post({path: userPath + '/:userId' + '/memberships/create' , version: '0.0.7'} , core.createApplication);
server.post({path: userPath + '/:userId' + '/memberships/:bodyCode/modify' , version: '0.0.9'} , core.modifyMembership);
...
server.post({path: antennaePath + '/create' , version: '0.0.7'} , core.createAntenna);
